      ...
      <div className="py-12 sm:py-16 md:py-24 px-4 sm:px-8 md:px-12 border-t border-midnight">
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 auto-rows-fr">
            <div className="card-midnight h-full flex flex-col">
              <div className="w-14 h-14 rounded-xl flex items-center justify-center mb-4 glow-coral flex-shrink-0" style={{background: 'rgba(255, 107, 107, 0.1)'}}>
                <svg className="w-7 h-7 text-coral" fill="currentColor" viewBox="0 0 20 20">
                  <path fillRule="evenodd" d="M5 9V7a5 5 0 0110 0v2a2 2 0 012 2v5a2 2 0 01-2 2H5a2 2 0 01-2-2v-5a2 2 0 012-2zm8-2v2H7V7a3 3 0 016 0z" clipRule="evenodd" />
                </svg>
              </div>
              <h3 className="text-xl font-semibold text-primary mb-3">
                Analytics & Velocity Dashboard
              </h3>
              <p className="text-muted flex-grow">
                Visualize your language distribution and track your 30-day commit velocity across all bookmarked repositories with interactive Recharts.
              </p>
            </div>
            ...
            <div className="card-midnight h-full flex flex-col">
              ...
              <p className="text-muted flex-grow">
                Monitor native GitHub Actions workflows in real-time and scaffold production applications with One-Click Deployments to Vercel and Render.
              </p>
            </div>
            ...
            <div className="card-midnight h-full flex flex-col">
              ...
              <p className="text-muted flex-grow">
                Get highly accurate, deterministic Pull Request reviews. The AI checks merge conflicts and CI status before making its final verdict.
              </p>
            </div>
            ...
            <div className="card-midnight h-full flex flex-col">
              ...
              <p className="text-muted flex-grow">
                Never refresh again. Our background poller detects GitHub events and broadcasts them instantly to your Live Activity Feed via Socket.io.
              </p>
            </div>
