        ...
        <Link href="/bookmarks" className="group">
          <div className="card-midnight p-8">
            <div className="flex items-center justify-between mb-6">
              ...
              <span className="text-5xl font-bold text-coral">{stats.bookmarks}</span>
            </div>
            <h3 className="text-xl font-semibold text-primary mb-2">Bookmarks</h3>
        ...
        <div className="card-midnight">
          ...
          <div className="space-y-3">
            ...
            <Link href="/issues" className="flex items-center gap-4 p-4 rounded-lg hover:bg-opacity-80 transition-colors group border border-midnight" style={{background: 'var(--bg-tertiary)'}}>
              ...
              <span className="text-primary font-medium text-lg">Create Issue</span>
            </Link>
          </div>
        </div>
